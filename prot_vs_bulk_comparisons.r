...
#tiff(file='~/prot-lineage/figures/FEMALE_tree_rnaseq_pstime.tiff',height=85,width=100,units='mm',res=300)
tiff(file='~/prot-lineage/figures/MALE_tree_rnaseq_pstime.tiff',height=85,width=100,units='mm',res=300)
g <- plot_cell_trajectory(MonRun,color_by = "rnaseq_pseudotime",show_branch_points=F,use_color_gradient = F,cell_size = 0.5) + scale_color_gradient (low="blue", high="red")
g
dev.off()
