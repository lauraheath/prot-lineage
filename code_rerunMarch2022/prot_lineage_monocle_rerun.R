...
RunMonocleTobit <- function(Dat, Labels, max_components=2, meth = 'DDRTree',C_by = NULL, 
  ...
  #will need to reverse for female samples
...
#saveRDS(Dat2, file="~/neuropath_lineages/proteomics/Dx_analysis/Female_matrix_rownames.rds")
saveRDS(Dat2, file="~/neuropath_lineages/proteomics/Dx_analysis/Male_matrix_rownames.rds")
temp <- Dat2
temp2 <- Meta2
...
MonRun$State2[MonRun$State == 10] <- 5
...
#saveRDS(MonRun, file="~/neuropath_lineages/proteomics/Dx_analysis/Female_monocleObject.rds")
saveRDS(MonRun, file="~/neuropath_lineages/proteomics/Dx_analysis/Male_monocleObject.rds")


###### FIGURES #########
#tiff(file='~/neuropath_lineages/proteomics/Dx_analysis/FEMALE_tree_state.tiff',height=85,width=100,units='mm',res=300)
tiff(file='~/neuropath_lineages/proteomics/Dx_analysis/MALE_tree_state.tiff',height=85,width=100,units='mm',res=300)
...
#tiff(file='~/neuropath_lineages/proteomics/Dx_analysis/FEMALE_tree_diagnosis.tiff',height=85,width=100,units='mm',res=300)
tiff(file='~/neuropath_lineages/proteomics/Dx_analysis/MALE_tree_diagnosis.tiff',height=85,width=100,units='mm',res=300)
...
#tiff(file='~/neuropath_lineages/proteomics/Dx_analysis/FEMALE_tree_braak.tiff',height=85,width=100,units='mm',res=300)
tiff(file='neuropath_lineages/proteomics/Dx_analysis/MALE_tree_braak.tiff',height=85,width=100,units='mm',res=300)
...
#tiff(file='~/neuropath_lineages/proteomics/Dx_analysis/FEMALE_tree_apoe.tiff',height=85,width=100,units='mm',res=300)
tiff(file='~/neuropath_lineages/proteomics/Dx_analysis/MALE_tree_apoe.tiff',height=85,width=100,units='mm',res=300)
...
#tiff(file='~/neuropath_lineages/proteomics/Dx_analysis/FEMALE_tree_cerad.tiff',height=85,width=100,units='mm',res=300)
tiff(file='~/neuropath_lineages/proteomics/Dx_analysis/MALE_tree_cerad.tiff',height=85,width=100,units='mm',res=300)
...
#tiff(file='~/neuropath_lineages/proteomics/Dx_analysis/FEMALE_tree_cogdx.tiff',height=85,width=100,units='mm',res=300)
tiff(file='~/neuropath_lineages/proteomics/Dx_analysis/MALE_tree_cogdx.tiff',height=85,width=100,units='mm',res=300)
...
#tiff(file='~/neuropath_lineages/proteomics/Dx_analysis/FEMALE_bargraph_braak.tiff',height=85,width=100,units='mm',res=300)
tiff(file='~/neuropath_lineages/proteomics/Dx_analysis/MALE_bargraph_braak.tiff',height=85,width=100,units='mm',res=300)
...
#tiff(file='~/neuropath_lineages/proteomics/Dx_analysis/FEMALE_bargraph_cerad.tiff',height=85,width=100,units='mm',res=300)
tiff(file='~/neuropath_lineages/proteomics/Dx_analysis/MALE_bargraph_cerad.tiff',height=85,width=100,units='mm',res=300)
...
#tiff(file='~/neuropath_lineages/proteomics/Dx_analysis/FEMALE_bargraph_cogdx.tiff',height=85,width=100,units='mm',res=300)
tiff(file='~/neuropath_lineages/proteomics/Dx_analysis/MALE_bargraph_cogdx.tiff',height=85,width=100,units='mm',res=300)
...
#write.csv(prot_pstime_covars_F, file="~/neuropath_lineages/proteomics/Dx_analysis/female_pseudotimes_states.csv", row.names=FALSE)
#file <- synapser::File(path='~/neuropath_lineages/proteomics/Dx_analysis/female_pseudotimes_states.csv', parentId='syn28558769')
#file <- synapser::synStore(file)

write.csv(prot_pstime_covars_F, file="~/neuropath_lineages/proteomics/Dx_analysis/male_pseudotimes_state.csv", row.names=FALSE)
file <- synapser::File(path='~/neuropath_lineages/proteomics/Dx_analysis/male_pseudotimes_state.csv', parentId='syn28558769')
file <- synapser::synStore(file)
...
#tiff(file='~/neuropath_lineages/proteomics/Dx_analysis/FEMALE_bargraph_diagnosis.tiff',height=170,width=200,units='mm',res=300)
tiff(file='~/neuropath_lineages/proteomics/Dx_analysis/MALE_bargraph_diagnosis.tiff',height=170,width=200,units='mm',res=300)
...
#are pseudotimes from the old analysis correlated with pseudotimes from the new analysis?
#female
old_psOBJ <- synapser::synGet('syn25764732')
old_ps <- read.csv(old_psOBJ$path)

#male
old_psOBJ <- synapser::synGet('syn25764737')
old_ps <- read.csv(old_psOBJ$path)

x <- old_ps$Pseudotime
y <- Fvariables$Pseudotime
cor.test(x,y,method="pearson")
cor.test(x,y,method="spearman")

corrs <- subset(Fvariables, select=c(SampleID, Pseudotime, pseudotime_sc))
names(corrs)[names(corrs) == "Pseudotime"] <- "Pseudotime_new"
names(corrs)[names(corrs) == "pseudotime_sc"] <- "pseudotime_sc_new"
corrs$Pseudotime_old <- old_ps$Pseudotime
corrs$pseudotime_sc_old <- old_ps$pseudotime_sc

ggscatter(corrs, x = "Pseudotime_old", y = "Pseudotime_new", 
