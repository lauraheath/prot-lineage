...
MonRun <- readRDS(file="~/neuropath_lineages/proteomics/Dx_analysis/Female_monocleObject.rds")
temp <- readRDS(file="~/neuropath_lineages/proteomics/Dx_analysis/Female_matrix_rownames.rds")
table(MonRun$State2)
...
write.csv(df4,file='~/neuropath_lineages/proteomics/Dx_analysis/female_DEanova_stats.csv',quote=F,row.names=F)
file <- synapser::File(path='~/neuropath_lineages/proteomics/Dx_analysis/female_DEanova_stats.csv', parentId='syn28558769')
...
MonRun <- readRDS(file="~/neuropath_lineages/proteomics/Dx_analysis/Male_monocleObject.rds")
temp <- readRDS(file="~/neuropath_lineages/proteomics/Dx_analysis/Male_matrix_rownames.rds")
table(MonRun$State2)
...
write.csv(df4,file='~/neuropath_lineages/proteomics/Dx_analysis/male_DEanova_stats.csv',quote=F,row.names=F)
file <- synapser::File(path='~/neuropath_lineages/proteomics/Dx_analysis/male_DEanova_stats.csv', parentId='syn28558769')
file <- synapser::synStore(file)
