...
###save file specifying which patients are in which / both studies
Meta2 <- subset(Meta, select=c(individualID, rnaseq_id, batchChannel, rnaseq, proteomics))
write.csv(Meta2, file="~/prot-lineage/data/patientIDS_rnaseq_proteomics.csv", row.names=FALSE)
